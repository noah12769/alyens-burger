  ...
  return (
    <>
      ...
      <footer className="section-footer">
          ...
          <div className="left-footer">
            ...
            <div className="footer-social-div">
              <div className="footer-social">
                <a
                  href="https://www.instagram.com/alyens_burger"
              ...
              <div className="footer-social">
                <a
                  href="https://www.tiktok.com/@alyens_burger"
                  className="footer-social-icon"
                  target="_blank"
                  rel="noopener noreferrer"
                >
        ...
        <div className="incipit-div">
          <p className="incipit-text">
            ...
            <a
              href="https://www.instagram.com/lumea.fx?igsh=MTVpYjBveTQzdmEyaw=="
              className="incipit-link"
              target="_blank"
              rel="noopener noreferrer"
            >LUMEA</a>
          </p>
      ...
      <div
        ...
        style={{ display: "none" }}
        onClick={(e) => {
          if (e.target === directionsOverlayRef.current)
        ...
        <div className="directions-sheet" role="dialog" aria-modal="true">
          ...
          <div className="directions-body">
            ...
            >
              ...
              <span className="dir-badge">Rapide</span>
            </a>
            <a
              href={gmapsUrl}
              className="dir-btn"
            ...
            >
              ...
              <span className="dir-badge">Classique</span>
            </a>
            <a
              href={appleUrl}
              className="dir-btn"
            ...
            >
              ...
              <span className="dir-badge">iPhone</span>
            </a>
          </div>
        </div>
      </div>
